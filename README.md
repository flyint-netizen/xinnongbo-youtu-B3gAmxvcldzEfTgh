...
[https://github.com/cby\-chen/Kubernetes](https://github.com) 开源不易，帮忙点个star，谢谢了
...
## 手动项目地址：[https://github.com/cby\-chen/Kubernetes](https://github.com)
...
| 软件 | 版本 |
| --- | --- |
| cni\_plugins\_version | v1\.6\.1 |
| cri\_containerd\_cni\_version | 2\.0\.1 |
| crictl\_version | v1\.32\.0 |
| cri\_dockerd\_version | 0\.3\.16 |
| etcd\_version | v3\.5\.17 |
| cfssl\_version | 1\.6\.5 |
| kubernetes\_server\_version | 1\.32\.0 |
| docker\_version | 27\.4\.0 |
| runc\_version | 1\.2\.3 |
| kernel\_version | 5\.4\.278 |
| helm\_version | 3\.16\.3 |
| nginx\_version | 1\.27\.3 |
...
安装包已经整理好：[https://mirrors.chenby.cn/https://github.com/cby\-chen/Kubernetes/releases/download/v1\.32\.0/kubernetes\-v1\.32\.0\.tar](https://github.com)
...
```
# 写入nginx配置文件
cat > /usr/local/nginx/conf/kube-nginx.conf <# 这段配置是一个nginx的stream模块的配置，用于代理TCP和UDP流量。
# 
...
# 写入启动配置文件
cat > /etc/systemd/system/kube-nginx.service <# 这是一个用于kube-apiserver的NGINX代理的systemd单位文件。
# 
...
k8s-master01   NotReady       16s   v1.32.0
k8s-master02   NotReady       13s   v1.32.0
k8s-master03   NotReady       12s   v1.32.0
k8s-node01     NotReady       10s   v1.32.0
k8s-node02     NotReady       9s    v1.32.0
[root@k8s-master01 ~]#
...
cilium-monitoring   grafana          NodePort    10.111.74.3              3000:32648/TCP   74s
cilium-monitoring   prometheus       NodePort    10.107.240.124           9090:30495/TCP   74s
kube-system         hubble-ui        NodePort    10.96.185.26             80:31568/TCP     99s
...
NAME                              TYPE       CLUSTER-IP     EXTERNAL-IP   PORT(S)         AGE
kubernetes-dashboard-kong-proxy   NodePort   10.96.247.74           443:30465/TCP   2m29s
[root@k8s-master01 ~]# 
...
[https://192\.168\.1\.31:30465/](https://github.com):[veee加速器](https://blog.liuyunzhuge.com)
...
NAME           TYPE        CLUSTER-IP            EXTERNAL-IP   PORT(S)        AGE
chenby         NodePort    fd00:1111::361a               80:30915/TCP   5s
[root@k8s-master01 ~]# 
...
[https://www.oiox.cn/](https://github.com)


[https://www.oiox.cn/index.php/start\-page.html](https://github.com)
